...
(103, 'Pedro Trilheiro', 'Descobrindo novas trilhas em SP', 'https://example.com/avatar103.jpg', '1988-11-08', 'MALE', 'SÃ£o Paulo, SP', '+5511987654323', 'ADVANCED', 'HIKING', 'PUBLIC', true, false),
...
(105, 'JoÃ£o Explorador', 'Aventuras em busca do desconhecido', 'https://example.com/avatar105.jpg', '1987-09-12', 'MALE', 'Porto Alegre, RS', '+5551987654325', 'EXPERT', 'ADVENTURE', 'PUBLIC', true, false),
(106, 'Fernanda Caminhante', 'Trilhas sÃ£o minha paixÃ£o', 'https://example.com/avatar106.jpg', '1991-12-03', 'FEMALE', 'Salvador, BA', '+5571987654326', 'INTERMEDIATE', 'HIKING', 'PUBLIC', true, false),
...
(108, 'Camila Rocha', 'FotÃ³grafa de natureza', 'https://example.com/avatar108.jpg', '1993-04-25', 'FEMALE', 'BrasÃ­lia, DF', '+5561987654328', 'EXPERT', 'PHOTOGRAPHY', 'PUBLIC', true, false),
...
(111, 'Diego Aventura', 'Trilheiro de fim de semana', 'https://example.com/avatar111.jpg', '1994-10-29', 'MALE', 'GoiÃ¢nia, GO', '+5562987654331', 'INTERMEDIATE', 'HIKING', 'PUBLIC', true, false),
(112, 'PatrÃ­cia Natureza', 'Conectada com a natureza', 'https://example.com/avatar112.jpg', '1988-03-16', 'FEMALE', 'FlorianÃ³polis, SC', '+5548987654332', 'ADVANCED', 'RELAXATION', 'PUBLIC', true, true),
(113, 'Rafael Pico', 'Escalador e montanhista', 'https://example.com/avatar113.jpg', '1983-07-21', 'MALE', 'VitÃ³ria, ES', '+5527987654333', 'EXPERT', 'ADVENTURE', 'PUBLIC', true, false),
...
(115, 'Thiago Mata', 'PreservaÃ§Ã£o e aventura', 'https://example.com/avatar115.jpg', '1990-02-28', 'MALE', 'BelÃ©m, PA', '+5591987654335', 'INTERMEDIATE', 'RESEARCH', 'PUBLIC', true, true)
